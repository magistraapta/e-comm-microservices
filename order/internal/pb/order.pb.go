...
const file_internal_pb_order_proto_rawDesc = "" +
	"\n" +
	"\x17internal/pb/order.proto\x12\x05order\"f\n" +
	...
	"\fOrderService\x12D\n" +
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponseB\x0fZ\r./internal/pbb\x06proto3"
...
var file_internal_pb_order_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
