...
const file_internal_product_pb_product_proto_rawDesc = "" +
	"\n" +
	"!internal/product/pb/product.proto\x12\aproduct\"V\n" +
	...
	"\rDecreaseStock\x12\x1d.product.DecreaseStockRequest\x1a\x1e.product.DecreaseStockResponseB\x17Z\x15./internal/product/pbb\x06proto3"

var (
	file_internal_product_pb_product_proto_rawDescOnce sync.Once
	file_internal_product_pb_product_proto_rawDescData []byte
)

func file_internal_product_pb_product_proto_rawDescGZIP() []byte {
	file_internal_product_pb_product_proto_rawDescOnce.Do(func() {
		file_internal_product_pb_product_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_product_pb_product_proto_rawDesc), len(file_internal_product_pb_product_proto_rawDesc)))
	})
	return file_internal_product_pb_product_proto_rawDescData
}

var file_internal_product_pb_product_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_internal_product_pb_product_proto_goTypes = []any{
...
func file_internal_product_pb_product_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_product_pb_product_proto_rawDesc), len(file_internal_product_pb_product_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
