...
const file_internal_auth_pb_auth_proto_rawDesc = "" +
	"\n" +
	"\x1binternal/auth/pb/auth.proto\x12\x04auth\"_\n" +
	...
	"\bValidate\x12\x15.auth.ValidateRequest\x1a\x16.auth.ValidateResponseB\x14Z\x12./internal/auth/pbb\x06proto3"

var (
	file_internal_auth_pb_auth_proto_rawDescOnce sync.Once
	file_internal_auth_pb_auth_proto_rawDescData []byte
)

func file_internal_auth_pb_auth_proto_rawDescGZIP() []byte {
	file_internal_auth_pb_auth_proto_rawDescOnce.Do(func() {
		file_internal_auth_pb_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_auth_pb_auth_proto_rawDesc), len(file_internal_auth_pb_auth_proto_rawDesc)))
	})
	return file_internal_auth_pb_auth_proto_rawDescData
}

var file_internal_auth_pb_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_internal_auth_pb_auth_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_auth_pb_auth_proto_rawDesc), len(file_internal_auth_pb_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
